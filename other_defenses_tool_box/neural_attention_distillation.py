    ...
    def train_teacher(self):
        ...
        for epoch in range(0, self.teacher_epochs):
            ...
            if epoch == 0:
                ...
                test(teacher, test_loader=self.test_loader, poison_test=True, poison_transform=self.poison_transform, num_classes=self.num_classes, source_classes= config.source_class, all_to_all=('all_to_all' in self.args.dataset))
            ...
            acc_clean, acc_bad = test(teacher, test_loader=self.test_loader, poison_test=True, poison_transform=self.poison_transform, num_classes=self.num_classes, source_classes= config.source_class, all_to_all=('all_to_all' in self.args.dataset))
    ...
    def train_erase(self):
        ...
        for epoch in range(0, self.erase_epochs):
            ...
            if epoch == 0:
                ...
                test(student, test_loader=self.test_loader, poison_test=True, poison_transform=self.poison_transform, num_classes=self.num_classes, source_classes= config.source_class, all_to_all=('all_to_all' in self.args.dataset))
            ...
            # acc_clean, acc_bad = acc_clean[0], acc_bad[0]
            acc_clean, acc_bad = test(student, test_loader=self.test_loader, poison_test=True, poison_transform=self.poison_transform, num_classes=self.num_classes, source_classes= config.source_class, all_to_all=('all_to_all' in self.args.dataset))
